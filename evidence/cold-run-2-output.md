# Cold run 2: OMB Memorandum M-25-21, section 3, as translated under the revised rules
...
| R10 | «Agencies must notify 0MB within 30 days when the designated CAIO changes or the position is vacant.» L26 | «must» MUST | «Agencies» L26 | not in source | not in source | «within 30 days when the designated CAIO changes or the position is vacant» L26 | intention: owner, evidence |
...
| R34 | «Agencies must enable trained and accountable agency officials at the lowest appropriate level21 to identify, assess, mitigate, and accept risk for AI use cases.22» L70 | «must» MUST | «Agencies» L70 | not in source | not in source | not in source | intention: owner, evidence, when |
...
| R37 | «Agencies must also include plans to update any existing internal AI principles and guidelines to ensure consistency with this memorandum.23» L72 | «must» MUST | «Agencies» L72 | not in source | «plans to update any existing internal AI principles and guidelines» L72 | not in source | intention: owner, when |
