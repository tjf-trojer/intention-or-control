...
| R9 | «Following a one-week notification period on the bots noticeboard, and the operator's talk page, prior task approvals will be considered expired and bot flags will be removed.» L31 | «will» WILL | not in source | not in source | «a one-week notice on the bots noticeboard» L31 | «Following a one-week notification period» L31 | intention: owner |
