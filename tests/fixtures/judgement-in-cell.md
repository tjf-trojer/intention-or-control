...
| R3 | «Bots must edit only while logged into their account.» L19 | «must» MUST | «Bots» L19 | «its operator» L21 | not in source (the policy should name a log) | not in source | intention: evidence, when |
