<!-- expect: scope -->
# Fixture: evidence-from-elsewhere
...
| R3 | «Bots must edit only while logged into their account.» L19 | «must» MUST | «Bots» L19 | «its operator» L21 | «its user page» L21 | not in source | intention: when |
