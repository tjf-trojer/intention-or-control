...
| R8 | «Bot accounts that have had no logged actions or edits for two years, where the listed operator has also had no logged actions or edits for two years, will be deauthorized.» L31 | «will» WILL | not in source | «the Bot Approvals Group» L31 | not in source | «for two years» L31 | intention: evidence |
