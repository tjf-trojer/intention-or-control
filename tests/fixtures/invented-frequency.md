...
| R10 | «Should the operator return and wish to reactivate the bot, a new request for approval (BRFA) must be completed.» L31 | «must» MUST | «the operator» L31 | «the operator» L31 | «a new request for approval (BRFA)» L31 | «annually» L31 | control |
